...
export default async function LandscapeGapAnalysisPage({
  searchParams,
}: {
    ...
    <div className="p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-zinc-500 dark:text-zinc-400 mt-1">Goal achievement vs. landscape opportunity</p>
        </div>

        {/* Goal Type Filter */}
        <div className="flex items-center gap-2">
          <Link
            href="/landscape/gaps?type=revenue"
          ...
          <Link
            href="/landscape/gaps?type=logos"
            className={`px-3 py-1.5 rounded-md text-sm font-medium transition-colors ${
      ...
      <div className="grid grid-cols-4 gap-4 mb-8">
        ...
        <div className="rounded-lg bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 p-4">
          <p className="text-sm text-purple-600 dark:text-purple-400">Landscape Opportunity</p>
